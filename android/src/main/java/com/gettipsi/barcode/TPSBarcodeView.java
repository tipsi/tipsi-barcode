...
import com.gettipsi.barcode.ui.camera.CameraSource;
import com.gettipsi.barcode.ui.camera.CameraSourcePreview;
import com.gettipsi.barcode.ui.camera.GraphicOverlay;
...
public class TPSBarcodeView extends CameraSourcePreview {
    private static final String TAG = "TPSBarcodeView";
    // intent request code to handle updating play services if needed.
    private static final int RC_HANDLE_GMS = 9001;
    private CameraSource mCameraSource;
    private GraphicOverlay<BarcodeGraphic> mGraphicOverlay;

    public TPSBarcodeView(Context context, AttributeSet attr) {
        super(context, attr);
